...
export default defineSkipprDocs({
  ...
  sidebar: {"/": [{"text": "Home", "link": "/"}, {"text": "CLI", "items": [{"text": "init", "link": "/cli/init"}, {"text": "connect", "link": "/cli/connect"}, {"text": "discover", "link": "/cli/discover"}, {"text": "sync", "link": "/cli/sync"}, {"text": "doctor", "link": "/cli/doctor"}, {"text": "model", "link": "/cli/model"}]}]},
})
