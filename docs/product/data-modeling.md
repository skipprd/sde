---
title: Data modeling
description: "Turn bronze warehouse tables into dimensions, facts, and metrics with skippr model. The agent writes dbt you review, test, and keep in your repo."
---
...
3. **Validate** — compile and run against your warehouse (`skippr test` for dbt tests).
...
- [`skippr model`](/elt/cli/model)
- [`skippr test`](/elt/cli/test)
